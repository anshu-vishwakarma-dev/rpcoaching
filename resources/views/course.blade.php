...
<div class="drawer" id="drawer">
 ...
 <div class="top-banner">
  ...
  <div class="container">
    <h2>Math courses for Class 11th</h2>

    <div class="filters">
      <button>⚙️ Filters</button>
      <select>
    ...
    <div class="courses-section">
      ...
      <div class="cards">
        <div class="card">
          ...
          <span class="last-batch">LAST BATCH</span>
          <h3>Nurture Online Course</h3>
          <p>Weekday Batch</p>
          <ul>
            <li>Live classes from ALLEN Kota's top faculty</li>
            <li>Up to 20 online tests</li>
            <li>24/7 doubt resolution, mentorship & more</li>
          </ul>
          <p class="price">₹85,000 <small>+ Taxes applicable</small></p>
    ...
    <div class="courses-section">
      ...
      <div class="course-cards">
        <div class="course-box">
          ...
          <h3>Nurture Self-Study Plus (2–year)</h3>
          <p>Video lectures + Test Series</p>
          <ul>
            <li>1250+ high-quality recorded lectures covering full syllabus</li>
            <li>Digital study material incl. books, RACE’s & more</li>
            <li>40+ (part + full) syllabus tests</li>
          </ul>
          <p class="price">₹12,500 <small>+ Taxes applicable</small></p>
          <a href="#" class="know-more">Know more ➝</a>
        </div>

        <div class="course-box">
          <span class="badge">🎥 RECORDED</span>
          <h3>Nurture Self-Study Plus (1–year)</h3>
          <p>Video lectures + Test Series</p>
          <ul>
            <li>700+ high-quality recorded lectures covering full syllabus</li>
            <li>Digital study material incl. books, RACE’s & more</li>
            <li>25 (part + full) syllabus tests</li>
          </ul>
          <p class="price">₹9,000 <small>+ Taxes applicable</small></p>
          <a href="#" class="know-more">Know more ➝</a>
        </div>
      </div>
    </div>
    ...
    <div class="courses-section">
      ...
      <div class="course-cards">
        <div class="course-box">
          <span class="badge">📝 ONLINE TEST SERIES</span>
          <h3>Nurture Test Series</h3>
          <p>All India Test Series – ONLINE mode</p>
          <ul>
            <li>25 (part + full) syllabus tests</li>
            <li>Detailed solutions of all questions</li>
            <li>Exclusive ALLEN's Question Bank</li>
          </ul>
          <p class="price">₹6,700 <small>+ Taxes applicable</small></p>
          <a href="#" class="know-more">Know more ➝</a>
        </div>

        <div class="course-box">
          <span class="badge">📝 OFFLINE TEST SERIES</span>
          <h3>Nurture Test Series (Allen DLP)</h3>
          <p>All India Test Series – PEN & PAPER mode</p>
          <ul>
            <li>19 (part + full) syllabus tests</li>
            <li>Access largest network of 300+ test centers</li>
          </ul>
          <p class="price">₹12,712 <small>+ Taxes applicable</small></p>
          <a href="#" class="know-more">Know more ➝</a>
        </div>
      </div>
    </div>
...
<div class="toppers">
    <img src="{{ asset('images/toppers.jpg') }}" alt="">
</div>
